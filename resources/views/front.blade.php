...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="{{ asset('frontend/css/datetimepicker.css') }}">
<style>
...
.owl-carousel .owl-wrapper, .owl-carousel .owl-item:nth-child({{$key+1}}) .item
{
 ...
 <div class="container">
                        ...
                        <div class="col-md-10 col-md-offset-1">
                            ...
                            @foreach($items as $item)
                                <li class="item {{$item->category->slug}}">
                                    ...
                                    <a href="#">
                                        <img src="{{ asset('uploads/items/'.$item->image) }}" class="img-responsive" alt="{{$item->category->name}}" >
                    ...
                    <div class=" section-content">
                        <div class="row">
                            <div class="col-md-5 col-sm-6">
                                <form class="reservation-form" method="post" action="{{route('front.reservation')}}">
                                @csrf
                                    <div class="row">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-10 col-md-offset-1 col-sm-10 col-sm-offset-1">
                        <div class="row">
                             <form class="contact-form" method="post" action="{{route('front.contact')}}">
                             @csrf
        ...
        <script src="{{ asset('frontend/js/datetimepicker.js') }}"></script>
        <script>
        @if ($errors->any())
